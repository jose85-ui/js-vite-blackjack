  ...
  * @param {Array<Strint>} tiposDeCarta Ejemplo: ['C','D','H','S'];
  * @param {Array<Strint>} tiposEspeciales Ejemplo: ['A','J','Q','K'];
...
// export default crearDeck; Programa la exportacion por defecto
